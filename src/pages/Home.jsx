  ...
  return (
    <>
      ...
      <section className="relative flex flex-col lg:flex-row justify-between min-h-[85vh]">
        <div className="flex xl:flex-wrap xl:justify-center pt-[6%] pb-[6%] lg:pb-0 flex-1 items-start lg:pl-6 flex-col w-full gap-4 xl:w-1/2">
          <div className="text-center lg:text-start mx-auto px-3 flex flex-col gap-4">
