  ...
  function onSubmit(e) {
    e.preventDefault();
      fetch("https://formcarry.com/s/X4QKpNgXeNa", {
        ...
        body: JSON.stringify({ email, message : "This user wants to contact you" }),
      })
      ...
      <div className="flex flex-col justify-between gap-4 py-6 px-6 bg-gradient-to-r from-neutral-100 to-stone-300">
        <div className="flex items-center gap-2 lg:py-8 font-medium text-xl">
          <img
            src={logoimage}
            alt=""
            className="h-8 w-8 lg:h-14 lg:w-14 rounded-full object-cover object-center"
          />
          <span className="text-2xl lg:text-3xl text-black">Digitals</span>
        </div>
          ...
          <div className="flex flex-1 items-start md:items-center justify-start flex-col text-black">
            <div className="flex flex-col gap-3">
              ...
              <form onSubmit={(e) => onSubmit(e)}>
                ...
                />
                <button type='submit' className="py-[0.35rem] px-3 border bg-black text-white rounded-r border-white">
                  sumbit
                </button>
              </form>
            </div>
        ...
        <li className='flex my-3 items-center justify-start gap-2 text-blue-700 font-medium'><span className='text-red-600'>GST NO.</span> 10ELLPK2267P1ZQ</li>
          ...
          <div className="text-black flex items-center gap-6 mt-3">
            ...
            <Link to="https://www.instagram.com/kjdigitals2024/" className='hover:text-[#ed4c4c]'><FaInstagram size={"26px"} /></Link>
            <li className='flex items-center justify-start gap-1 hover:text-[#209520]'><span className='hover:text-[#8b32f7]'><CgMail size={'28px'} /></span> kjdegitals@gmail.com</li>
          </div>
        </div>
      </div>
